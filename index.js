...
if (typeof window.orientation !== 'undefined') { 
    alert('Sorry, but the site is not yet responsive for phone. This is under development.');
}
/**
 * Configs
 */
...
var main = (function () {
    ...
    var cmds = {
        YES: {value : "yes", help: null},
        NO: {value: "no", help: null}
    };
    ...
    Terminal.prototype.handleCmd = function () {
        ...
        this.lock();
        switch (cmdComponents[0].toLowerCase()) {
            case "yes":
                window.location.href="/Terminal/index.html";
                break;
            case "no":
                window.location.href="/Graphic/index.html";
                break;
            default:
